...
{	
	...
	/*else if (exten == "txt" || exten == "notecard")
	{
		// skip forward and just copy to vfs as is
...
class CreateTextCompleteUploadCallback : public LLAssetUploadResponder
{
public:
	CreateTextCompleteUploadCallback(const LLSD& post_data,
									 const LLUUID& vfile_id,
									 LLAssetType::EType asset_type,
									 S32 expected_cost) : LLAssetUploadResponder(post_data, vfile_id, asset_type)
	{
